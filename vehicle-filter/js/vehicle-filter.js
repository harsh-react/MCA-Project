jQuery(document).ready(function($) {
    ...
    */
    ...
    function showVehicleSummary() {
        ...
        const html = `
            <div class="vehicle-summary-box" style="background:#f5f6fa;padding:1.5em 1em;border-radius:8px;display:flex;align-items:center;justify-content:space-between;">
                <div>
                    <span style="color:green;font-size:1.5em;vertical-align:middle;">&#10004;</span>
                    <strong style="margin-left:0.5em;">We have found your vehicle</strong>
                    <div style="margin-top:0.5em;">${summary}</div>
                </div>
                <div style="display:flex;gap:1em;align-items:center;">
                    <a href="#" id="change-vehicle-btn" style="text-decoration:underline;cursor:pointer;">Change</a>
                    <a href="#" id="reset-vehicle-btn" style="text-decoration:underline;cursor:pointer;color:#e85c0c;">Reset</a>
                </div>
            </div>
        `;
