        ...
        <!-- <div class="fcp1">
            ...
            <form method="post" action="<?php echo esc_url(home_url('/')); ?>">
                ...
                <div class="fcp1_content">
                    <label for="enter_reg" class="fcp1_label"><span class="no-display">Search by number plate</span></label>
        ...
        <div class="find_car_parts_form">
            <form id="vehicle-filter-form">
                <div class="fcp-row">
                    ...
                    <div class="fcp-col fcp-col-12">
                        <button type="submit" class="button btn-primary search-button vehicle-filter-btn">Search Parts</button>
                    </div>
                </div>
            </form>
        </div>        
...
// Add JS in the footer to update product titles if vehicleFilter is present
    ...
    (function() {
        ...
        if (vehicleFilter) {
            try {
                ...
                const vehicleInfo = `${vehicleData.make}, ${vehicleData.model}, ${vehicleData.listing}, ${vehicleData.year}, ${vehicleData.engine}`;
                // Find all product titles and modify them
                document.querySelectorAll(
                    '.product_title, .woocommerce-loop-product__title, .product-title'
                ).forEach(function(element) {
                    if (!element.hasAttribute('data-original-title')) {
                        element.setAttribute('data-original-title', element.textContent);
                    }
                    element.textContent = `${element.getAttribute('data-original-title')} (Compatible with ${vehicleInfo})`;
                });
            } catch (e) {
